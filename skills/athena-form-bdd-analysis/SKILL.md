...
description: >
  ...
  由 /athena-discovery 在 Strategic 完成後、Tactical 開始前 DELEGATE 觸發。
---
...
change_summary 中附帶 IMPL_IMPACT 表，格式見 `athena-core/references/reconciler-contract.md`。
