...
2. Run `/athena-discovery` (Address what you wanna build)
...
| `/athena-discovery` | **Root planner** | Turns raw ideas into boundary-aware discovery truth, sourcing reports, activity intent, and feature-rule skeletons. |
