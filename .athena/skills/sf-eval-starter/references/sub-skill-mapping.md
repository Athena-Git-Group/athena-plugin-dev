...
|---|---|---|
| `RED` | `/aibdd-red-execute` | `<worker project>/.athena/skills/aibdd-red-execute/SKILL.md` |
| `GREEN` | `/aibdd-green-execute` | `<worker project>/.athena/skills/aibdd-green-execute/SKILL.md` |
| `REFACTOR` | `/aibdd-refactor-execute` | `<worker project>/.athena/skills/aibdd-refactor-execute/SKILL.md` |
...
```bash
test -f .athena/skills/aibdd-red-execute/SKILL.md \
  && test -f .athena/skills/aibdd-green-execute/SKILL.md \
  && test -f .athena/skills/aibdd-refactor-execute/SKILL.md
```
