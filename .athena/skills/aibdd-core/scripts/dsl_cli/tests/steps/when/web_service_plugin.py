...
# This file lives at:
#   .athena/skills/aibdd-core/scripts/dsl_cli/tests/steps/when/web_service_plugin.py
# parents indexing:
#   [0] when/  [1] steps/  [2] tests/  [3] dsl_cli/  [4] scripts/  [5] aibdd-core/
# The on-disk boundaries root is .athena/skills/aibdd-core/assets/boundaries/
