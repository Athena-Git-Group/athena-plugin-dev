...
3. 確認 discovery 產物存在，否則停止。
   ...
   3.5 IF assertion fails:
       3.5.1 EMIT "discovery 產物缺失；請先跑 /athena-discovery" to user
       3.5.2 STOP
