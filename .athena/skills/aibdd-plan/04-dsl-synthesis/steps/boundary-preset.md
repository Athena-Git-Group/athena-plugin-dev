...
2. （選）READ boundary preset profile — `.athena/skills/aibdd-core/assets/boundaries/${boundary_type}/profile.yml` — 供其他 phase 參考；stage 4 本身不再依賴 profile 中任何欄位來規劃 entry 結構（plugin 已自含該知識）。
