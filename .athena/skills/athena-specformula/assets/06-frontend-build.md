...
| 順序 | Skill | 做什麼 | 前提 |
|------|-------|--------|------|
| 1 | `/athena-auto-frontend-apifirst-msw-starter` | 前端骨架 Batch A-F + Gate A-F | — |
| 2 | `/athena-auto-frontend-msw-api-layer` | 從 api.yml 產生 MSW handlers | Starter 完成 |
| 3 | `/athena-auto-frontend-nextjs-pages` | 頁面 + UI 實作 | API Layer 完成 |
...
- 詳見 `/athena-auto-frontend-apifirst-msw-starter` 的 `references/batch-gates.md`
